...
# Only initialize non-widget keys (widget keys get their value from the widget itself)
_init_defaults = {
    "lut_path": "None",
    "output_format": "jpeg",
...
sb.slider("Quality", min_value=1, max_value=100, value=90, key="output_quality")
